...
export default function ContactPage({
  ...
  return (
    <div className="font-body-lg text-body-lg bg-surface text-on-surface min-h-screen flex flex-col transition-colors duration-300">
      {/* TopNavBar with Framer Motion Entrance */}
      <motion.header
        initial={{ y: -20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.5, ease: "easeOut" }}
        className="w-full sticky top-0 z-50 bg-surface-container-lowest/80 backdrop-blur-md border-b border-outline-variant transition-colors"
      >
        <nav className="flex justify-between items-center px-margin-desktop py-4 max-w-container-max mx-auto">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div className="flex flex-col text-left">
                <span className="font-display-lg text-title-md font-bold text-primary dark:text-secondary-container">Forma</span>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a className="text-secondary dark:text-secondary-container font-bold border-b-2 border-secondary dark:border-secondary-container pb-1 font-title-md text-body-sm transition-colors duration-200" href="#contact">Contact</a>
          </div>

          <div className="flex items-center gap-2 sm:gap-4">
            <MobileNav active="Contact" signedIn={!!user} />
            <button
              onClick={() => setIsDarkMode(!isDarkMode)}
              className="w-10 h-10 flex items-center justify-center rounded-full border border-outline-variant hover:bg-secondary/10 hover:border-secondary dark:hover:border-secondary-container text-on-surface-variant hover:text-secondary dark:hover:text-secondary-container transition-all active:scale-95 cursor-pointer mr-1 select-none"
            ...
            {user ? (
              <div className="flex items-center gap-4 relative" ref={profileMenuRef}>
                ...
                <button
                  ...
                  className="hidden lg:inline-block whitespace-nowrap font-label-caps text-on-surface-variant text-body-sm px-4 py-2 hover:text-secondary dark:hover:text-secondary-container hover:bg-surface-container-low dark:hover:bg-[#1a2332] rounded-full transition-all active:scale-95 cursor-pointer"
                >
                  Workspace
                </button>

                {showProfileMenu && (
                  <div className="absolute right-0 top-full mt-2 w-56 bg-surface-container-lowest border border-outline-variant rounded-2xl shadow-2xl z-50 overflow-hidden py-2 text-left">
                    <div className="px-4 py-3 border-b border-outline-variant/30 flex flex-col">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-error-container dark:hover:bg-red-950/30 text-error hover:text-error transition-colors text-left text-xs font-semibold font-label-caps cursor-pointer"
                    >
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <button
                  onClick={onSignUp}
                  className="whitespace-nowrap bg-secondary-container text-white px-4 sm:px-6 py-2 font-label-caps transition-all hover:bg-secondary-container/90 active:scale-95 rounded-full shadow-lg shadow-secondary-container/20 cursor-pointer"
                >
                  Sign Up
                </button>
              </div>
      ...
      {/* Footer */}
      <footer className="w-full bg-surface-container-lowest dark:bg-card border-t border-outline-variant py-10 mt-auto transition-colors">
        <div className="max-w-container-max mx-auto px-margin-desktop flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 text-[11px] text-on-surface-variant font-sans">
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2 select-none text-[12px]">
            <a href="#" className="hover:text-primary dark:hover:text-secondary-container transition-all duration-200 hover:scale-105">Product</a>
            <span className="text-outline-variant text-[21px] font-bold">•</span>
            <a href="#features" className="hover:text-primary dark:hover:text-secondary-container transition-all duration-200 hover:scale-105">Features</a>
            <span className="text-outline-variant text-[21px] font-bold">•</span>
            <a href="#docs" className="hover:text-primary dark:hover:text-secondary-container transition-all duration-200 hover:scale-105">Docs</a>
            <span className="text-outline-variant text-[21px] font-bold">•</span>
            <a href="#contact" className="hover:text-primary dark:hover:text-secondary-container transition-all duration-200 hover:scale-105">Contact</a>
            <span className="text-outline-variant text-[21px] font-bold">•</span>
            <a href="#" className="hover:text-primary dark:hover:text-secondary-container transition-all duration-200 text-on-surface-variant/70 hover:scale-105">Privacy</a>
            <span className="text-outline-variant text-[21px] font-bold">•</span>
            <a href="#" className="hover:text-primary dark:hover:text-secondary-container transition-all duration-200 text-on-surface-variant/70 hover:scale-105">Terms</a>
          </div>

          {/* Right side: (Verified Stack removed as per requirements) */}
          <div className="flex items-center gap-6 flex-wrap lg:justify-end">
            {/* Removed Verified Stack */}
          </div>
