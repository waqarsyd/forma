...
- **The working tree is now a git repository**, initialised on 2026-08-09 with the whole project as one initial commit. `git diff` and `git log` work; there is no remote, so nothing has been pushed.
