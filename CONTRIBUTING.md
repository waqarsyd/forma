...
32 commits merged as `bb7d298`, each stating what changed, what it was worth, and what was
verified. `git log f0734e3..bb7d298` is the record. (Twelve phase reports also existed
under `docs/cleanup/`; they were removed on 2026-08-29 and are recoverable from history
with `git show 5afe96c:docs/cleanup/09-results.md` or similar.)
