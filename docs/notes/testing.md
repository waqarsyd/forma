...
`npm test` runs Vitest over **1,145 tests in 53 files** — under the `node` environment
...
**Total: 1,145 in 53 files** — and that total is the arithmetic sum of the column above
