...
`npm test` runs Vitest over **1,156 tests in 53 files** — under the `node` environment
...
**Total: 1,156 in 53 files** — and that total is the arithmetic sum of the column above
...
A grep for `\bit(` answers **1,134** against a real 1,156 and will talk you into
