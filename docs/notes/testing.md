...
`npm test` runs Vitest over **1,314 tests in 59 files** — under the `node` environment
...
**Total: 1,314 in 59 files** — and that total is the arithmetic sum of the column above
...
A grep for `\bit(` answers **1,286** against a real 1,314 and will talk you into
