...
`npm test` runs Vitest over **1,111 tests in 52 files** — under the `node` environment
...
**Total: 1,111 in 52 files** — and that total is the arithmetic sum of the column above
...
A grep for `\bit(` answers **1,089** against a real 1,111 and will talk you into
