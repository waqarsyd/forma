...
```
git show 4677a5a:docs/audit/06-roadmap.md          # the roadmap and severity table
git show 4677a5a:docs/audit/07-implementation.md   # what was actually built, and what it cost
git show 4677a5a:docs/audit/00-inventory.md        # 01-runbook, 02-architecture, 03-test-audit,
...
by the 2026-08-28 cleanup, which is recorded in `git log 72214ab..f6046c1`.
...
- **A handful of IDs appear in the reports but are not cited anywhere in the code**
  ...
  `git show 4677a5a:docs/audit/06-roadmap.md`.
