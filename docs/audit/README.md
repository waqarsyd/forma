...
```
git show ecfe42c:docs/audit/06-roadmap.md          # the roadmap and severity table
git show ecfe42c:docs/audit/07-implementation.md   # what was actually built, and what it cost
git show ecfe42c:docs/audit/00-inventory.md        # 01-runbook, 02-architecture, 03-test-audit,
...
by the 2026-08-28 cleanup, which is recorded in `git log f0734e3..bb7d298`.
...
- **A handful of IDs appear in the reports but are not cited anywhere in the code**
  ...
  `git show ecfe42c:docs/audit/06-roadmap.md`.
