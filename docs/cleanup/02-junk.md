...
| `.antigravity/` | 22.14 MB | Live editor state for an editor you are presumably still using. Moving it is a change to your tooling, not a cleanup. Already gitignored, already documented in `CLAUDE.md`. |
